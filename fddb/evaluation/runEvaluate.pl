...
#### VARIABLES TO EDIT ####
# where gnuplot is
my $GNUPLOT = "/home/ulsee/often/usr/gnuplot-5.2.4/bin/gnuplot"; 
# where the binary is
my $evaluateBin = "./evaluate"; 
# where the images are
my $imDir = "/home/ulsee/often/lqc/often-mtcnn/fddb/originalPics/"; 
# where the folds are
my $fddbDir = "/home/ulsee/often/lqc/often-mtcnn/fddb/FDDB-folds/"; 
# where the detections are
my $detDir = "/home/ulsee/often/lqc/often-mtcnn/fddb/Res/"; 
###########################
